...
#define scm_c_local_error(i,d) local_error_origin=scm_from_locale_symbol(__func__);local_error_name=scm_from_locale_symbol(i);local_error_data=d;\
  goto error
...
#define scm_error_return_1(a) if(scm_is_true(scm_call_1(scm_error_p,a))){return(a);}
#define scm_error_return_2(a,b) scm_error_return_1(a);\
  scm_error_return_1(b)
#define scm_error_return_3(a,b,c) scm_error_return_2(a,b);\
  scm_error_return_1(c)
#define scm_error_return_4(a,b,c,d) scm_error_return_2(a,b);\
