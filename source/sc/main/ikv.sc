...
(hashtable-declare-type ikv ikv-key-t* ikv-value-t ikv-hash-64 ikv-equal 2)
...
(declare ikv-read-value-t (type (function-pointer status-t char* size-t ikv-value-t*)))
