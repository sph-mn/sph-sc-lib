(pre-include-once stdio-h "stdio.h" inttypes-h "inttypes.h" assert-h "assert.h" time-h "time.h")
...
(define (insert-values a) (mi-list-64-t* mi-list-64-t*)
  ...
  (while counter (set a (mi-list-64-add a counter)) (set counter (- counter 1)))
...
(define (main) int
  ...
  (test-value-existence a) (print-contents a) (mi-list-64-destroy a) (printf "success\n") (return 0))
