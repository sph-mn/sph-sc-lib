...
(define-macro (mi-list-first a)
  (if* (= 0 a) 0 (deref (convert-type (struct-deref a data) mi-list-element-t*))))

(define-macro (mi-list-first-address a)
  (if* (= 0 a) 0 (convert-type (struct-deref a data) mi-list-element-t*)))
