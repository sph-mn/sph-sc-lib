...
(pre-if-not-defined mi-list-first
  (begin (pre-define (mi-list-first a) (struct-pointer-get a data))
...
(define ((mi-list-name destroy) a) (void mi-list-t*)
  (define a-next mi-list-t* 0) (while a (set a-next (struct-pointer-get a link)) (free a) (set a a-next)))
...
(define ((mi-list-name add) a value) (mi-list-t* mi-list-t* mi-list-element-t)
  ...
  (set (struct-pointer-get element data) value (struct-pointer-get element link) a) (return element))
