...
#define feq_margin sph_f64_nearly_equal
...
status_t test_spline_path() {
  ...
  test_helper_assert(("path 0.0"), (feq_margin(0, (out[0]), error_margin)));
  test_helper_assert(("path 0.4"), (feq_margin(0, (out[4]), error_margin)));
  test_helper_assert(("path 0.5"), (feq_margin(5, (out[5]), error_margin)));
  test_helper_assert(("path 0.15"), (feq_margin(10, (out[15]), error_margin)));
  test_helper_assert(("path 0.16"), (feq_margin((10.75), (out[16]), error_margin)));
  test_helper_assert(("path 0.34"), (feq_margin((24.25), (out[34]), error_margin)));
  test_helper_assert(("path 0.35"), (feq_margin(25, (out[35]), error_margin)));
  test_helper_assert(("path 0.49"), (feq_margin(25, (out[49]), error_margin)));
  /* path 0 new-get */
  ...
  test_helper_assert(("path 1.9 - should reach maximum at 9"), (feq_margin((4.5), (out[9]), error_margin)));
  test_helper_assert(("path 1.10 - should not set the next start point"), (feq_margin(0, (out[10]), error_margin)));
  test_helper_assert(("path 1.11 - should be zero after segments"), (feq_margin(0, (out[11]), error_margin)));
...
status_t test_spline_path_helpers() {
  ...
  segments[2] = spline_path_bezier2(20, 15, 30, 5, 40, 15);
  segments[3] = spline_path_constant();
  ...
  test_helper_assert("helper path 0", (feq_margin(0, (out[0]), error_margin)));
  test_helper_assert("helper path 49", (feq_margin(15, (out[49]), error_margin)));
...
status_t test_spline_path_bezier_arc() {
  ...
  segments[0] = spline_path_bezier_arc((end_x / 3), (end_y / 3), 0);
